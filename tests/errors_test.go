...
func TestUnit_errors_BusinessRuleException(t *testing.T) {
	err := beanstream.BeanstreamApiException{302, 0, 0, "Test error message", "none", "Test error"}
	assert.True(t, strings.Contains(err.Error(), "BusinessRuleException"), "Error is not a BusinessRuleException")

	err = beanstream.BeanstreamApiException{402, 0, 0, "Test error message", "none", "Test error"}
	assert.True(t, strings.Contains(err.Error(), "BusinessRuleException"), "Error is not a BusinessRuleException")
}

func TestUnit_errors_UnexpectedException(t *testing.T) {
	err := beanstream.BeanstreamApiException{-1, 0, 0, "Test error message", "none", "Test error"}
...
func TestUnit_errors_InvalidRequestException(t *testing.T) {
	err := beanstream.BeanstreamApiException{400, 0, 0, "Test error message", "none", "Test error"}
	assert.True(t, strings.Contains(err.Error(), "InvalidRequestException"), "Error is not an InvalidRequestException")

	err = beanstream.BeanstreamApiException{405, 0, 0, "Test error message", "none", "Test error"}
	assert.True(t, strings.Contains(err.Error(), "InvalidRequestException"), "Error is not an InvalidRequestException")

	err = beanstream.BeanstreamApiException{415, 0, 0, "Test error message", "none", "Test error"}
	assert.True(t, strings.Contains(err.Error(), "InvalidRequestException"), "Error is not an InvalidRequestException")
}

func TestUnit_errors_UnauthorizedException(t *testing.T) {
	err := beanstream.BeanstreamApiException{401, 0, 0, "Test error message", "none", "Test error"}
...
func TestUnit_errors_ForbiddenException(t *testing.T) {
	err := beanstream.BeanstreamApiException{403, 0, 0, "Test error message", "none", "Test error"}
...
func TestUnit_errors_NotFoundException(t *testing.T) {
	err := beanstream.BeanstreamApiException{404, 0, 0, "Test error message", "none", "Test error"}
...
func TestUnit_errors_InternalServerException(t *testing.T) {
	err := beanstream.BeanstreamApiException{123, 0, 0, "Test error message", "none", "Test error"}
